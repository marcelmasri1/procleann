...
VALUES
  ('p1','p1',4.5,'4 L','surface','#1E7A66','#2F9C84',
   ...
   'منظف الأسطح — الصنوبر',
   'تركيبة تنظيف عميق للأسطح، غنية برائحة صنوبر الغابة المنعشة. تنظف أسطح المنزل بفعالية مع القضاء على الروائح غير المرغوب فيها.',1),
  ('p2','p2',6.9,'3 L','laundry','#0E9AA0','#1FBAC0',
   ...
   'منظف الغسيل الشامل',
   'منظف غسيل سائل عالي الفعالية، مصمم لإزالة أقوى البقع مع الحفاظ على الأقمشة. يمنح رائحة منعشة تدوم طويلاً، ومثالي لغسل كميات كبيرة من ملابس العائلة.',2),
  ('p3','p3',2.4,'750 ml','dish','#12BCCB','#3FD3DE',
   ...
   'غسيل الأطباق — نعناع',
   'سائل غسيل أطباق برائحة النعناع المنعشة، مصمم لإزالة أصعب بقع الدهون عن الأطباق وأواني الطهي، مع الحفاظ على نعومة اليدين دون تهيج.',3),
  ('p4','p4',2.4,'750 ml','dish','#C9BE18','#E0D63A',
   ...
   'غسيل الأطباق — ليمون',
   'منظف أطباق كلاسيكي بقوة الليمون، مصمم لإزالة الدهون بسرعة، مع رغوة غزيرة ولمعان خالٍ من البقع.',4),
  ('p5','p5',3.2,'500 ml','surface','#A9481C','#C7602F',
   ...
   'منظف ومطهر 2 في 1',
   'منظف مزدوج المفعول للأرضيات والأسطح، مصمم للقضاء على البكتيريا والتطهير الشامل، مع ترك لمعان قوي وخالٍ من الخطوط على جميع الأسطح الصلبة.',5),
  ('p6','p6',3.5,'4 L','laundry','#2C5EA6','#4B7FC4',
   'Heavy-Duty Bleach',
   ...
   'مبيض قوي المفعول',
   'محلول مركّز للتبييض والتعقيم، مصمم لإزالة البقع العميقة، وتبييض الملابس البيضاء، وتطهير أسطح الحمام والمطبخ.',6),
  ('p7','p7',2.9,'500 ml','care','#7FA9CC','#9CC0DD',
   ...
   'جل يدين سائل لطيف ومرطب، مصمم للقضاء على الجراثيم دون تجفيف البشرة. برائحة ناعمة ولطيفة تناسب الاستخدام اليومي لجميع أفراد العائلة.',7),
  ('p8','p8',5.5,'4 L','surface','#9A8FD0','#B6AEE0',
   ...
   'منظف الأسطح — لافندر',
   'منظف منزلي متعدد الأسطح بلمسة زهرية ناعمة، يجمع بين قوة التنظيف ورائحة اللافندر المهدئة التي تدوم طويلاً.',8),
  ('p9','p9',5.5,'4 L','surface','#DC3E77','#EC6394',
   ...
   'منظف الأسطح — كامي',
   'منظف شامل للأرضيات والأسطح يزيل الأوساخ والأتربة، ويترك المنزل معطراً برائحة زهور منعشة تدوم طويلاً.',9),
  ('p10','p10',5.5,'4 L','surface','#2AA3C2','#4FBBD6',
   ...
   'منظف الأسطح — نسيم المحيط',
   'منظف متعدد الأسطح للأرضيات والمنزل، بعبق زهري منعش يشبه أمواج المحيط. تركيبة خاصة لإزالة الأوساخ اليومية مع الحفاظ على انتعاش المنزل طوال اليوم.',10),
  ('p11','p11',4.9,'4 L','dish','#1C97A8','#37B4C4',
   'Dishwash — Cool Mint',
   'Heavy-duty liquid dishwashing detergent infused with a crisp cool mint scent. Effortlessly cuts through stubborn grease and dried food particles, leaving cookware sparkling clean.',
   'غسيل الأطباق — النعناع المنعش',
   'منظف أطباق فائق القوة برائحة النعناع المنعشة، يزيل الدهون العنيدة وبقايا الطعام الجاف بسهولة، تاركاً الأواني نظيفة ولامعة.',11)
